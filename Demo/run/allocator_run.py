...
print("Check if pulsar is running")
PulsarREST.get_tenants(pulsar_admin_url=cfg0.pulsar_admin_url)
print("Pulsar is running")
...
# cfg0.user_uuid = f"allocator_{uuid.uuid4().hex}"
cfg0.user_uuid = f"allocator_{uuid.uuid4().hex}"
