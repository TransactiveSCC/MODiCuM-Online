...
WORKDIR /demo/app
COPY Demo/service-examples/Carta-preproc/frames /demo/app/frames


COPY Demo/run/cfg.py /demo/app/
COPY Demo/run/influx_cfg.py /demo/app/
COPY Demo/service-examples/Carta-People-Counting/demo_cfg.py /demo/app/
COPY Demo/service-examples/Carta-People-Counting/common/ /demo/app/
COPY Demo/service-examples/Carta-People-Counting/frame_source/app-shim-input.py /demo/app/

ENTRYPOINT ["python", "/demo/app/app-shim-input.py"]
#CMD ["python", "/demo/app/app-shim-input.py", "pulsar://172.21.20.70:6650", "public", "default", "customer_1", "allocation_1"]
#CMD ["/bin/sh"]